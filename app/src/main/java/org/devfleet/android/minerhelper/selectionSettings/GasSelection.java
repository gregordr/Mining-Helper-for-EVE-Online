...
public class GasSelection extends AppCompatActivity {
    ...
    public void openSelection(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(GasSelection.this);
    ...
    public void checkButton(View view) {
        ...
        if ((Wormhole == view)) {
            editor.putBoolean("CBGW", Wormhole.isChecked());
        }
        if ((Mykoserocin == view)) {
            editor.putBoolean("CBGM", Mykoserocin.isChecked());
        }
        if ((Cytoserocin == view)) {
            editor.putBoolean("CBGC", Cytoserocin.isChecked());
        }
        editor.commit();
